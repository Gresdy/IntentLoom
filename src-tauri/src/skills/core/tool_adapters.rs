...
pub fn custom_tool_paths(store: &crate::skills::core::skill_store::SkillStore) -> HashMap<String, String> {
    store
...
pub fn custom_tool_project_paths(
    store: &crate::skills::core::skill_store::SkillStore,
...
pub fn custom_tools(store: &crate::skills::core::skill_store::SkillStore) -> Vec<CustomToolDef> {
    store
...
pub fn all_tool_adapters(store: &crate::skills::core::skill_store::SkillStore) -> Vec<ToolAdapter> {
