...
use crate::skills::commands::projects::{
...
use crate::skills::core::skill_store::{SkillRecord, SkillStore, SkillTargetRecord};
...
mod tests {
    ...
    use crate::skills::core::skill_store::{ScenarioRecord, SkillRecord, SkillStore};
    use crate::skills::core::{central_repo, installer};
