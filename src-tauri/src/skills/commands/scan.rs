...
fn match_imported_skill_id(
    rec: &crate::skills::core::skill_store::DiscoveredSkillRecord,
    managed_skills: &[crate::skills::core::skill_store::SkillRecord],
) -> Option<String> {
...
pub async fn import_existing_skill(
    ...
    tauri::async_runtime::spawn_blocking(move || {
        sync_metadata::with_repo_lock("import existing skill", || {
            ...
            let record = crate::skills::core::skill_store::SkillRecord {
                id: id.clone(),
                name: result.name,
...
mod tests {
    ...
    use crate::skills::core::skill_store::{DiscoveredSkillRecord, SkillRecord};
