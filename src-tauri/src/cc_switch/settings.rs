...
use crate::cc_switch::services::skill::{SkillStorageLocation, SyncMethod};
...
impl WebDavSyncSettings {
    pub fn validate(&self) -> Result<(), crate::cc_switch::error::AppError> {
        if self.base_url.trim().is_empty() {
            return Err(crate::cc_switch::error::AppError::localized(
