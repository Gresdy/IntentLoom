...
use crate::cc_switch::commands::{CodexOAuthState, CopilotAuthState};
use crate::cc_switch::proxy::providers::codex_oauth_auth::CodexOAuthManager;
use crate::cc_switch::proxy::providers::copilot_auth::CopilotAuthManager;
use crate::cc_switch::{
    app_config::AppType,
...
impl RequestForwarder {
    ...
    async fn forward(
        ...
        let mapped_body = if matches!(app_type, AppType::ClaudeDesktop) {
            crate::cc_switch::claude_desktop_config::map_proxy_request_model(body.clone(), provider)
...
mod tests {
    ...
    use crate::cc_switch::provider::LocalProxyRequestOverrides;
    ...
    fn test_provider_with_type(provider_type: Option<&str>) -> Provider {
        Provider {
            ...
            sort_index: None,
            notes: None,
            meta: provider_type.map(|value| crate::cc_switch::provider::ProviderMeta {
    ...
    fn canonical_json_sorts_object_keys_for_cache_trace_hashes() {
        ...
        assert_eq!(
            crate::cc_switch::proxy::json_canonical::canonical_json_string(&left),
            crate::cc_switch::proxy::json_canonical::canonical_json_string(&right)
        );
        assert_eq!(
    ...
    fn build_gemini_native_url_uses_origin_when_base_ends_with_v1beta() {
        let url = crate::cc_switch::proxy::gemini_url::build_gemini_native_url(
    ...
    fn resolve_gemini_native_url_keeps_opaque_full_url_as_is() {
        let url = crate::cc_switch::proxy::gemini_url::resolve_gemini_native_url(
