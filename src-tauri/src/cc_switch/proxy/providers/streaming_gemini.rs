...
use crate::cc_switch::proxy::sse::{append_utf8_safe, strip_sse_field, take_sse_block};
use bytes::Bytes;
...
mod tests {
    use super::*;
    use crate::cc_switch::proxy::providers::gemini_shadow::GeminiShadowStore;
    use crate::cc_switch::proxy::providers::transform_gemini::anthropic_to_gemini_with_shadow;
    use std::sync::Arc;
