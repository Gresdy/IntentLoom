...
use crate::cc_switch::codex_config::get_codex_config_dir;
use crate::cc_switch::database::{lock_conn, Database};
use crate::cc_switch::error::AppError;
use crate::cc_switch::proxy::usage::calculator::{CostCalculator, ModelPricing};
use crate::cc_switch::proxy::usage::parser::TokenUsage;
use crate::cc_switch::services::session_usage::{
    get_sync_state, metadata_modified_nanos, update_sync_state, SessionSyncResult,
};
use crate::cc_switch::services::usage_stats::{find_model_pricing, should_skip_session_insert, DedupKey};
...
fn insert_codex_session_entry(
    ...
    if inserted_rows > 0 {
        crate::cc_switch::usage_events::notify_log_recorded();
    }
