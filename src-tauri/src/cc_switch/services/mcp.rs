...
use crate::cc_switch::app_config::{AppType, McpServer};
use crate::cc_switch::error::AppError;
use crate::cc_switch::mcp;
...
impl McpService {
    ...
    pub fn import_from_claude(state: &AppState) -> Result<usize, AppError> {
        ...
        // 调用原有的导入逻辑（从 mcp.rs）
        let count = crate::cc_switch::mcp::import_from_claude(&mut temp_config)?;
    ...
    pub fn import_from_codex(state: &AppState) -> Result<usize, AppError> {
        ...
        // 调用原有的导入逻辑（从 mcp.rs）
        let count = crate::cc_switch::mcp::import_from_codex(&mut temp_config)?;
    ...
    pub fn import_from_gemini(state: &AppState) -> Result<usize, AppError> {
        ...
        // 调用原有的导入逻辑（从 mcp.rs）
        let count = crate::cc_switch::mcp::import_from_gemini(&mut temp_config)?;
    ...
    pub fn import_from_opencode(state: &AppState) -> Result<usize, AppError> {
        ...
        let count = crate::cc_switch::mcp::import_from_opencode(&mut temp_config)?;
    ...
    pub fn import_from_hermes(state: &AppState) -> Result<usize, AppError> {
        ...
        let count = crate::cc_switch::mcp::import_from_hermes(&mut temp_config)?;
