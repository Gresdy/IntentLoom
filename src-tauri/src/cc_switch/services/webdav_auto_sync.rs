...
async fn run_auto_sync_upload(
    db: &crate::cc_switch::database::Database,
    app: &AppHandle,
) -> Result<(), AppError> {
...
pub fn start_worker(db: Arc<crate::cc_switch::database::Database>, app: tauri::AppHandle) {
...
async fn run_worker_loop(
    db: Arc<crate::cc_switch::database::Database>,
...
mod tests {
    ...
    use crate::cc_switch::settings::WebDavSyncSettings;
    use std::time::{Duration, Instant};
