...
use crate::cc_switch::prompt::Prompt;
use crate::cc_switch::services::PromptService;
use crate::cc_switch::store::AppState;

#[tauri::command]
pub async fn cc_switch_get_prompts(
    app: String,
...
#[tauri::command]
pub async fn cc_switch_upsert_prompt(
    app: String,
    id: String,
    prompt: Prompt,
    state: State<'_, AppState>,
...
#[tauri::command]
pub async fn cc_switch_delete_prompt(
    app: String,
    id: String,
    state: State<'_, AppState>,
) -> Result<(), String> {
...
#[tauri::command]
pub async fn cc_switch_enable_prompt(
    app: String,
    id: String,
    state: State<'_, AppState>,
) -> Result<(), String> {
...
#[tauri::command]
pub async fn cc_switch_import_prompt_from_file(
    app: String,
    state: State<'_, AppState>,
...
#[tauri::command]
pub async fn cc_switch_get_current_prompt_file_content(app: String) -> Result<Option<String>, String> {
    let app_type = AppType::from_str(&app).map_err(|e| e.to_string())?;
