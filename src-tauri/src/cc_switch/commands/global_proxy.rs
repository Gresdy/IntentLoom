...
use crate::cc_switch::proxy::http_client;
...
#[tauri::command]
pub fn cc_switch_get_global_proxy_url(state: tauri::State<'_, AppState>) -> Result<Option<String>, String> {
...
#[tauri::command]
pub fn cc_switch_set_global_proxy_url(state: tauri::State<'_, AppState>, url: String) -> Result<(), String> {
...
#[tauri::command]
pub async fn cc_switch_test_proxy_url(url: String) -> Result<ProxyTestResult, String> {
...
#[tauri::command]
pub fn cc_switch_get_upstream_proxy_status() -> UpstreamProxyStatus {
...
/// 使用异步任务避免阻塞 UI 线程。
#[tauri::command]
pub async fn cc_switch_scan_local_proxies() -> Vec<DetectedProxy> {
