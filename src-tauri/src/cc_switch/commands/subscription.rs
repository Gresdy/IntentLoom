...
use crate::cc_switch::services::subscription::{CredentialStatus, SubscriptionQuota};
...
#[tauri::command]
pub async fn cc_switch_get_subscription_quota(
    app: tauri::AppHandle,
    state: State<'_, AppState>,
    tool: String,
) -> Result<SubscriptionQuota, String> {
    let inner = crate::cc_switch::services::subscription::get_subscription_quota(&tool).await;
