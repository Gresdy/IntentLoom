...
use crate::cc_switch::services::model_fetch::FetchedModel;
use crate::cc_switch::services::subscription::{query_codex_quota, CredentialStatus, SubscriptionQuota};
use std::sync::Arc;
use tauri::State;
...
pub async fn get_codex_oauth_models(
    ...
    crate::cc_switch::services::codex_oauth_models::fetch_models_with_token(&token, &id).await
}
