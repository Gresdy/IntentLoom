...
#[tauri::command]
pub fn cc_switch_import_hermes_providers_from_live(state: State<'_, AppState>) -> Result<usize, String> {
    crate::cc_switch::services::provider::import_hermes_providers_from_live(state.inner())
        .map_err(|e| e.to_string())
}

/// Get provider names in the Hermes live config.
#[tauri::command]
pub fn cc_switch_get_hermes_live_provider_ids() -> Result<Vec<String>, String> {
...
#[tauri::command]
pub fn cc_switch_get_hermes_live_provider(
...
#[tauri::command]
pub fn cc_switch_get_hermes_model_config() -> Result<Option<hermes_config::HermesModelConfig>, String> {
...
#[tauri::command]
pub fn cc_switch_get_hermes_memory(kind: hermes_config::MemoryKind) -> Result<String, String> {
    hermes_config::read_memory(kind).map_err(|e| e.to_string())
}

#[tauri::command]
pub fn cc_switch_set_hermes_memory(kind: hermes_config::MemoryKind, content: String) -> Result<(), String> {
    hermes_config::write_memory(kind, &content).map_err(|e| e.to_string())
}

#[tauri::command]
pub fn cc_switch_get_hermes_memory_limits() -> Result<hermes_config::HermesMemoryLimits, String> {
    hermes_config::read_memory_limits().map_err(|e| e.to_string())
}

#[tauri::command]
pub fn cc_switch_set_hermes_memory_enabled(
...
#[tauri::command]
pub async fn cc_switch_open_hermes_web_ui(app: AppHandle, path: Option<String>) -> Result<(), String> {
...
#[tauri::command]
pub async fn cc_switch_launch_hermes_dashboard() -> Result<(), String> {
    tokio::task::spawn_blocking(|| {
        crate::cc_switch::commands::misc::launch_terminal_running("hermes dashboard", "hermes_dashboard")
    })
    .await
