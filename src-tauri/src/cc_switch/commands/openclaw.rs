...
#[tauri::command]
pub fn cc_switch_import_openclaw_providers_from_live(state: State<'_, AppState>) -> Result<usize, String> {
    crate::cc_switch::services::provider::import_openclaw_providers_from_live(state.inner())
        .map_err(|e| e.to_string())
}

/// Get provider IDs in the OpenClaw live config.
#[tauri::command]
pub fn cc_switch_get_openclaw_live_provider_ids() -> Result<Vec<String>, String> {
...
#[tauri::command]
pub fn cc_switch_get_openclaw_live_provider(
...
#[tauri::command]
pub fn cc_switch_scan_openclaw_config_health() -> Result<Vec<openclaw_config::OpenClawHealthWarning>, String>
{
...
#[tauri::command]
pub fn cc_switch_get_openclaw_default_model() -> Result<Option<openclaw_config::OpenClawDefaultModel>, String>
{
...
#[tauri::command]
pub fn cc_switch_set_openclaw_default_model(
...
#[tauri::command]
pub fn cc_switch_get_openclaw_model_catalog(
...
#[tauri::command]
pub fn cc_switch_set_openclaw_model_catalog(
...
#[tauri::command]
pub fn cc_switch_get_openclaw_agents_defaults(
...
#[tauri::command]
pub fn cc_switch_set_openclaw_agents_defaults(
...
#[tauri::command]
pub fn cc_switch_get_openclaw_env() -> Result<openclaw_config::OpenClawEnvConfig, String> {
    openclaw_config::get_env_config().map_err(|e| e.to_string())
}

/// Set OpenClaw env config (env section of openclaw.json)
#[tauri::command]
pub fn cc_switch_set_openclaw_env(
...
#[tauri::command]
pub fn cc_switch_get_openclaw_tools() -> Result<openclaw_config::OpenClawToolsConfig, String> {
    openclaw_config::get_tools_config().map_err(|e| e.to_string())
}

/// Set OpenClaw tools config (tools section of openclaw.json)
#[tauri::command]
pub fn cc_switch_set_openclaw_tools(
