...
use crate::cc_switch::session_manager;

#[tauri::command]
pub async fn cc_switch_list_sessions() -> Result<Vec<session_manager::SessionMeta>, String> {
...
#[tauri::command]
pub async fn cc_switch_get_session_messages(
    providerId: String,
    sourcePath: String,
...
#[tauri::command]
pub async fn cc_switch_launch_session_terminal(
    command: String,
    cwd: Option<String>,
...
#[tauri::command]
pub async fn cc_switch_delete_session(
    providerId: String,
    sessionId: String,
    sourcePath: String,
) -> Result<bool, String> {
...
#[tauri::command]
pub async fn cc_switch_delete_sessions(
