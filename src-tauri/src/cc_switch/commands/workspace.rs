...
use crate::cc_switch::config::write_text_file;
use crate::cc_switch::openclaw_config::get_openclaw_dir;
...
#[tauri::command]
pub async fn cc_switch_list_daily_memory_files() -> Result<Vec<DailyMemoryFileInfo>, String> {
...
#[tauri::command]
pub async fn cc_switch_read_daily_memory_file(filename: String) -> Result<Option<String>, String> {
...
#[tauri::command]
pub async fn cc_switch_write_daily_memory_file(filename: String, content: String) -> Result<(), String> {
    validate_daily_memory_filename(&filename)?;
...
#[tauri::command]
pub async fn cc_switch_search_daily_memory_files(
    query: String,
...
#[tauri::command]
pub async fn cc_switch_delete_daily_memory_file(filename: String) -> Result<(), String> {
    validate_daily_memory_filename(&filename)?;
...
#[tauri::command]
pub async fn cc_switch_read_workspace_file(filename: String) -> Result<Option<String>, String> {
...
#[tauri::command]
pub async fn cc_switch_write_workspace_file(filename: String, content: String) -> Result<(), String> {
    validate_filename(&filename)?;
...
#[tauri::command]
pub async fn cc_switch_open_workspace_directory(handle: AppHandle, subdir: String) -> Result<bool, String> {
