...
#[tauri::command]
pub fn cc_switch_parse_deeplink(url: String) -> Result<DeepLinkImportRequest, String> {
...
#[tauri::command]
pub async fn cc_switch_import_from_deeplink_unified(
