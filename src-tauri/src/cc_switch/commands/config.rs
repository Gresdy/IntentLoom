...
#[tauri::command]
pub async fn cc_switch_get_claude_config_status() -> Result<ConfigStatus, String> {
...
#[tauri::command]
pub async fn cc_switch_get_config_status(
    ...
    match AppType::from_str(&app).map_err(|e| e.to_string())? {
        ...
        AppType::ClaudeDesktop => {
            let status = crate::cc_switch::claude_desktop_config::get_status(
                state.db.as_ref(),
        ...
        AppType::Gemini => {
            let env_path = crate::cc_switch::gemini_config::get_gemini_env_path();
            let exists = env_path.exists();
            let path = crate::cc_switch::gemini_config::get_gemini_dir()
                .to_string_lossy()
                .to_string();
        ...
        AppType::OpenCode => {
            let config_path = crate::cc_switch::opencode_config::get_opencode_config_path();
            let exists = config_path.exists();
            let path = crate::cc_switch::opencode_config::get_opencode_dir()
                .to_string_lossy()
                .to_string();
        ...
        AppType::OpenClaw => {
            let config_path = crate::cc_switch::openclaw_config::get_openclaw_config_path();
            let exists = config_path.exists();
            let path = crate::cc_switch::openclaw_config::get_openclaw_dir()
                .to_string_lossy()
                .to_string();
        ...
        AppType::Hermes => {
            ...
            let exists = config_path.exists();
            let path = crate::cc_switch::hermes_config::get_hermes_dir()
                .to_string_lossy()
                .to_string();
...
#[tauri::command]
pub async fn cc_switch_get_claude_code_config_path() -> Result<String, String> {
    Ok(get_claude_settings_path().to_string_lossy().to_string())
}

#[tauri::command]
pub async fn cc_switch_get_config_dir(app: String) -> Result<String, String> {
    let dir = match AppType::from_str(&app).map_err(|e| e.to_string())? {
        AppType::Claude => config::get_claude_config_dir(),
        AppType::ClaudeDesktop => {
            crate::cc_switch::claude_desktop_config::get_config_library_path().map_err(|e| e.to_string())?
        }
        ...
        AppType::OpenClaw => crate::cc_switch::openclaw_config::get_openclaw_dir(),
        AppType::Hermes => crate::cc_switch::hermes_config::get_hermes_dir(),
    };
...
#[tauri::command]
pub async fn cc_switch_open_config_folder(handle: AppHandle, app: String) -> Result<bool, String> {
...
#[tauri::command]
pub async fn cc_switch_pick_directory(
    app: AppHandle,
...
#[tauri::command]
pub async fn cc_switch_get_app_config_path() -> Result<String, String> {
    let config_path = config::get_app_config_path();
    Ok(config_path.to_string_lossy().to_string())
}

#[tauri::command]
pub async fn cc_switch_open_app_config_folder(handle: AppHandle) -> Result<bool, String> {
...
#[tauri::command]
pub async fn cc_switch_get_claude_common_config_snippet(
...
#[tauri::command]
pub async fn cc_switch_set_claude_common_config_snippet(
    snippet: String,
    state: tauri::State<'_, crate::cc_switch::store::AppState>,
) -> Result<(), String> {
...
#[tauri::command]
pub async fn cc_switch_get_common_config_snippet(
    app_type: String,
    state: tauri::State<'_, crate::cc_switch::store::AppState>,
) -> Result<Option<String>, String> {
    state
...
#[tauri::command]
pub async fn cc_switch_set_common_config_snippet(
    app_type: String,
    snippet: String,
    state: tauri::State<'_, crate::cc_switch::store::AppState>,
) -> Result<(), String> {
    ...
    if matches!(app_type.as_str(), "claude" | "codex" | "gemini") {
            ...
            .filter(|value| !value.trim().is_empty())
        {
            ...
            crate::cc_switch::services::provider::ProviderService::migrate_legacy_common_config_usage(
                state.inner(),
                app,
                legacy_snippet,
            )
    ...
    if matches!(app_type.as_str(), "claude" | "codex" | "gemini") {
        let app = AppType::from_str(&app_type).map_err(|e| e.to_string())?;
        crate::cc_switch::services::provider::ProviderService::sync_current_provider_for_app(
            state.inner(),
            app,
        )
        .map_err(|e| e.to_string())?;
    ...
    if app_type == "omo"
        && state
            ...
            .is_some()
    {
        crate::cc_switch::services::OmoService::write_config_to_file(
            state.inner(),
            &crate::cc_switch::services::omo::STANDARD,
        )
        .map_err(|e| e.to_string())?;
    }
            ...
            .is_some()
    {
        crate::cc_switch::services::OmoService::write_config_to_file(
            state.inner(),
            &crate::cc_switch::services::omo::SLIM,
        )
        .map_err(|e| e.to_string())?;
    }
    Ok(())
...
#[tauri::command]
pub async fn cc_switch_extract_common_config_snippet(
    appType: String,
    ...
    if let Some(settings_config) = settingsConfig.filter(|s| !s.trim().is_empty()) {
        ...
        return crate::cc_switch::services::provider::ProviderService::extract_common_config_snippet_from_settings(
            app,
            &settings,
        )
        .map_err(|e| e.to_string());
    ...
    crate::cc_switch::services::provider::ProviderService::extract_common_config_snippet(&state, app)
        .map_err(|e| e.to_string())
}
