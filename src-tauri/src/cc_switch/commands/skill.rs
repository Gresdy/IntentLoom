...
/// 获取所有已安装的 Skills
#[tauri::command]
pub fn cc_switch_get_installed_skills(app_state: State<'_, AppState>) -> Result<Vec<InstalledSkill>, String> {
    SkillService::get_all_installed(&app_state.db).map_err(|e| e.to_string())
}

#[tauri::command]
pub fn cc_switch_get_skill_backups() -> Result<Vec<SkillBackupEntry>, String> {
    SkillService::list_backups().map_err(|e| e.to_string())
}

#[tauri::command]
pub fn cc_switch_delete_skill_backup(backup_id: String) -> Result<bool, String> {
...
#[tauri::command]
pub async fn cc_switch_install_skill_unified(
...
/// 卸载 Skill（新版统一卸载）
#[tauri::command]
pub fn cc_switch_uninstall_skill_unified(
    id: String,
    app_state: State<'_, AppState>,
...
#[tauri::command]
pub fn cc_switch_restore_skill_backup(
    backup_id: String,
    current_app: String,
    app_state: State<'_, AppState>,
) -> Result<InstalledSkill, String> {
...
/// 切换 Skill 的应用启用状态
#[tauri::command]
pub fn cc_switch_toggle_skill_app(
    id: String,
    app: String,
    enabled: bool,
    app_state: State<'_, AppState>,
...
/// 扫描未管理的 Skills
#[tauri::command]
pub fn cc_switch_scan_unmanaged_skills(
    app_state: State<'_, AppState>,
...
/// 从应用目录导入 Skills
#[tauri::command]
pub fn cc_switch_import_skills_from_apps(
...
/// 发现可安装的 Skills（从仓库获取）
#[tauri::command]
pub async fn cc_switch_discover_available_skills(
    service: State<'_, SkillServiceState>,
    app_state: State<'_, AppState>,
...
/// 检查 Skills 更新
#[tauri::command]
pub async fn cc_switch_check_skill_updates(
    service: State<'_, SkillServiceState>,
    app_state: State<'_, AppState>,
...
/// 更新单个 Skill
#[tauri::command]
pub async fn cc_switch_update_skill(
    id: String,
    service: State<'_, SkillServiceState>,
    app_state: State<'_, AppState>,
) -> Result<InstalledSkill, String> {
...
/// 迁移 Skill 存储位置
#[tauri::command]
pub async fn cc_switch_migrate_skill_storage(
...
/// 搜索 skills.sh 公共目录
#[tauri::command]
pub async fn cc_switch_search_skills_sh(
    query: String,
    limit: usize,
    offset: usize,
...
/// 获取技能列表（兼容旧 API）
#[tauri::command]
pub async fn cc_switch_get_skills(
    service: State<'_, SkillServiceState>,
    app_state: State<'_, AppState>,
...
/// 获取指定应用的技能列表（兼容旧 API）
#[tauri::command]
pub async fn cc_switch_get_skills_for_app(
    app: String,
    service: State<'_, SkillServiceState>,
    app_state: State<'_, AppState>,
) -> Result<Vec<Skill>, String> {
    ...
    cc_switch_get_skills(service, app_state).await
}

/// 安装技能（兼容旧 API）
#[tauri::command]
pub async fn cc_switch_install_skill(
    directory: String,
    service: State<'_, SkillServiceState>,
    app_state: State<'_, AppState>,
) -> Result<bool, String> {
    cc_switch_install_skill_for_app("claude".to_string(), directory, service, app_state).await
}

/// 安装指定应用的技能（兼容旧 API）
#[tauri::command]
pub async fn cc_switch_install_skill_for_app(
    app: String,
    directory: String,
    service: State<'_, SkillServiceState>,
    app_state: State<'_, AppState>,
...
/// 卸载技能（兼容旧 API）
#[tauri::command]
pub fn cc_switch_uninstall_skill(
    directory: String,
    app_state: State<'_, AppState>,
) -> Result<SkillUninstallResult, String> {
    cc_switch_uninstall_skill_for_app("claude".to_string(), directory, app_state)
}

/// 卸载指定应用的技能（兼容旧 API）
#[tauri::command]
pub fn cc_switch_uninstall_skill_for_app(
    app: String,
    directory: String,
    app_state: State<'_, AppState>,
) -> Result<SkillUninstallResult, String> {
...
/// 获取技能仓库列表
#[tauri::command]
pub fn cc_switch_get_skill_repos(app_state: State<'_, AppState>) -> Result<Vec<SkillRepo>, String> {
    app_state.db.get_skill_repos().map_err(|e| e.to_string())
}

/// 添加技能仓库
#[tauri::command]
pub fn cc_switch_add_skill_repo(repo: SkillRepo, app_state: State<'_, AppState>) -> Result<bool, String> {
    app_state
        .db
...
/// 删除技能仓库
#[tauri::command]
pub fn cc_switch_remove_skill_repo(
    owner: String,
    name: String,
    app_state: State<'_, AppState>,
) -> Result<bool, String> {
...
/// 从 ZIP 文件安装 Skills
#[tauri::command]
pub fn cc_switch_install_skills_from_zip(
    file_path: String,
    current_app: String,
    app_state: State<'_, AppState>,
) -> Result<Vec<InstalledSkill>, String> {
