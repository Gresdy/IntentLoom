...
use crate::cc_switch::proxy::{CircuitBreakerConfig, CircuitBreakerStats};
use crate::cc_switch::store::AppState;

/// 启动代理服务器（仅启动服务，不接管 Live 配置）
#[tauri::command]
pub async fn cc_switch_start_proxy_server(
...
#[tauri::command]
pub async fn cc_switch_stop_proxy_server(state: tauri::State<'_, AppState>) -> Result<(), String> {
...
/// 停止代理服务器（恢复 Live 配置）
#[tauri::command]
pub async fn cc_switch_stop_proxy_with_restore(state: tauri::State<'_, AppState>) -> Result<(), String> {
    state.proxy_service.stop_with_restore().await
}

/// 获取各应用接管状态
#[tauri::command]
pub async fn cc_switch_get_proxy_takeover_status(
    state: tauri::State<'_, AppState>,
...
/// 为指定应用开启/关闭接管
#[tauri::command]
pub async fn cc_switch_set_proxy_takeover_for_app(
    state: tauri::State<'_, AppState>,
    app_type: String,
    enabled: bool,
) -> Result<(), String> {
...
/// 获取代理服务器状态
#[tauri::command]
pub async fn cc_switch_get_proxy_status(state: tauri::State<'_, AppState>) -> Result<ProxyStatus, String> {
    state.proxy_service.get_status().await
}

/// 获取代理配置
#[tauri::command]
pub async fn cc_switch_get_proxy_config(state: tauri::State<'_, AppState>) -> Result<ProxyConfig, String> {
    state.proxy_service.get_config().await
}

/// 更新代理配置
#[tauri::command]
pub async fn cc_switch_update_proxy_config(
    state: tauri::State<'_, AppState>,
    config: ProxyConfig,
) -> Result<(), String> {
...
#[tauri::command]
pub async fn cc_switch_get_global_proxy_config(
    state: tauri::State<'_, AppState>,
...
#[tauri::command]
pub async fn cc_switch_update_global_proxy_config(
    state: tauri::State<'_, AppState>,
...
#[tauri::command]
pub async fn cc_switch_get_proxy_config_for_app(
    state: tauri::State<'_, AppState>,
    app_type: String,
...
#[tauri::command]
pub async fn cc_switch_update_proxy_config_for_app(
    state: tauri::State<'_, AppState>,
...
/// 获取默认成本倍率
#[tauri::command]
pub async fn cc_switch_get_default_cost_multiplier(
    state: tauri::State<'_, AppState>,
    app_type: String,
...
/// 设置默认成本倍率
#[tauri::command]
pub async fn cc_switch_set_default_cost_multiplier(
    state: tauri::State<'_, AppState>,
    app_type: String,
    value: String,
) -> Result<(), String> {
...
/// 获取计费模式来源
#[tauri::command]
pub async fn cc_switch_get_pricing_model_source(
    state: tauri::State<'_, AppState>,
    app_type: String,
) -> Result<String, String> {
...
/// 设置计费模式来源
#[tauri::command]
pub async fn cc_switch_set_pricing_model_source(
    state: tauri::State<'_, AppState>,
    app_type: String,
    value: String,
) -> Result<(), String> {
...
/// 检查代理服务器是否正在运行
#[tauri::command]
pub async fn cc_switch_is_proxy_running(state: tauri::State<'_, AppState>) -> Result<bool, String> {
    Ok(state.proxy_service.is_running().await)
}

/// 检查是否处于 Live 接管模式
#[tauri::command]
pub async fn cc_switch_is_live_takeover_active(state: tauri::State<'_, AppState>) -> Result<bool, String> {
    state.proxy_service.is_takeover_active().await
}

/// 代理模式下切换供应商（热切换）
#[tauri::command]
pub async fn cc_switch_switch_proxy_provider(
    state: tauri::State<'_, AppState>,
    app_type: String,
    provider_id: String,
) -> Result<(), String> {
...
/// 获取供应商健康状态
#[tauri::command]
pub async fn cc_switch_get_provider_health(
    state: tauri::State<'_, AppState>,
    provider_id: String,
    app_type: String,
...
#[tauri::command]
pub async fn cc_switch_reset_circuit_breaker(
        ...
        if let Some(current_id) = current_id {
            ...
            if let (Some(restored), Some(current)) = (restored_order, current_order) {
                if restored < current {
                    ...
                    // 创建故障转移切换管理器并执行切换
                    let switch_manager =
                        crate::cc_switch::proxy::failover_switch::FailoverSwitchManager::new(db.clone());
...
/// 获取熔断器配置
#[tauri::command]
pub async fn cc_switch_get_circuit_breaker_config(
    state: tauri::State<'_, AppState>,
...
/// 更新熔断器配置
#[tauri::command]
pub async fn cc_switch_update_circuit_breaker_config(
    state: tauri::State<'_, AppState>,
...
#[tauri::command]
pub async fn cc_switch_get_circuit_breaker_stats(
    state: tauri::State<'_, AppState>,
    provider_id: String,
    app_type: String,
