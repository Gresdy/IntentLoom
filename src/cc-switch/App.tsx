...
import type { Provider, VisibleApps } from "@cc-switch/types";
import type { EnvConflict } from "@cc-switch/types/env";
import { useProvidersQuery, useSettingsQuery } from "@cc-switch/lib/query";
import {
  providersApi,
  settingsApi,
  type AppId,
  type ProviderSwitchEvent,
} from "@cc-switch/lib/api";
import { checkAllEnvConflicts, checkEnvConflicts } from "@cc-switch/lib/api/env";
import { useProviderActions } from "@cc-switch/hooks/useProviderActions";
import { openclawKeys, useOpenClawHealth } from "@cc-switch/hooks/useOpenClaw";
import { hermesKeys, useOpenHermesWebUI } from "@cc-switch/hooks/useHermes";
import { hermesApi } from "@cc-switch/lib/api/hermes";
import { useProxyStatus } from "@cc-switch/hooks/useProxyStatus";
import { useAutoCompact } from "@cc-switch/hooks/useAutoCompact";
import { useUsageCacheBridge } from "@cc-switch/hooks/useUsageCacheBridge";
import { useTauriEvent } from "@cc-switch/hooks/useTauriEvent";
import { useLastValidValue } from "@cc-switch/hooks/useLastValidValue";
import { useScanUnmanagedSkills } from "@cc-switch/hooks/useSkills";
import { extractErrorMessage } from "@cc-switch/utils/errorUtils";
import { isTextEditableTarget } from "@cc-switch/utils/domUtils";
import { deepClone } from "@cc-switch/utils/deepClone";
import { cn } from "@cc-switch/lib/utils";
import {
  isWindows,
  isLinux,
  DRAG_REGION_ATTR,
  DRAG_REGION_STYLE,
} from "@cc-switch/lib/platform";
import { AppSwitcher } from "@cc-switch/components/AppSwitcher";
import { ProviderList } from "@cc-switch/components/providers/ProviderList";
import { AddProviderDialog } from "@cc-switch/components/providers/AddProviderDialog";
import { EditProviderDialog } from "@cc-switch/components/providers/EditProviderDialog";
import { ConfirmDialog } from "@cc-switch/components/ConfirmDialog";
import { SettingsPage } from "@cc-switch/components/settings/SettingsPage";
import { UpdateBadge } from "@cc-switch/components/UpdateBadge";
import { EnvWarningBanner } from "@cc-switch/components/env/EnvWarningBanner";
import { ProxyToggle } from "@cc-switch/components/proxy/ProxyToggle";
import { ClaudeDesktopRouteToggle } from "@cc-switch/components/proxy/ClaudeDesktopRouteToggle";
import { FailoverToggle } from "@cc-switch/components/proxy/FailoverToggle";
import UsageScriptModal from "@cc-switch/components/UsageScriptModal";
import UnifiedMcpPanel from "@cc-switch/components/mcp/UnifiedMcpPanel";
import PromptPanel from "@cc-switch/components/prompts/PromptPanel";
import {
  SkillsPage,
  getSkillsPageHeaderActions,
  type SkillsPageSource,
} from "@cc-switch/components/skills/SkillsPage";
import UnifiedSkillsPanel from "@cc-switch/components/skills/UnifiedSkillsPanel";
import { DeepLinkImportDialog } from "@cc-switch/components/DeepLinkImportDialog";
import { FirstRunNoticeDialog } from "@cc-switch/components/FirstRunNoticeDialog";
import { AgentsPanel } from "@cc-switch/components/agents/AgentsPanel";
import { UniversalProviderPanel } from "@cc-switch/components/universal";
import { McpIcon } from "@cc-switch/components/BrandIcons";
import { Button } from "@cc-switch/components/ui/button";
import { SessionManagerPage } from "@cc-switch/components/sessions/SessionManagerPage";
import {
  useDisableCurrentOmo,
  useDisableCurrentOmoSlim,
} from "@cc-switch/lib/query/omo";
import WorkspaceFilesPanel from "@cc-switch/components/workspace/WorkspaceFilesPanel";
import EnvPanel from "@cc-switch/components/openclaw/EnvPanel";
import ToolsPanel from "@cc-switch/components/openclaw/ToolsPanel";
import AgentsDefaultsPanel from "@cc-switch/components/openclaw/AgentsDefaultsPanel";
import OpenClawHealthBanner from "@cc-switch/components/openclaw/OpenClawHealthBanner";
import HermesMemoryPanel from "@cc-switch/components/hermes/HermesMemoryPanel";
