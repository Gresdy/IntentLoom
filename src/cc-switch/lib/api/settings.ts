...
export const settingsApi = {
  async get(): Promise<Settings> {
    return await invoke("cc_switch_get_settings");
  },
  ...
  async hasCodexUnifyHistoryBackup(): Promise<boolean> {
    return await invoke("cc_switch_has_codex_unify_history_backup");
  },

  /** 按迁移备份账本把当时迁入共享桶的官方会话还原回 openai 桶（幂等） */
  async restoreCodexUnifiedHistory(): Promise<CodexUnifyHistoryRestoreResult> {
    return await invoke("cc_switch_restore_codex_unified_history");
  },

  async restart(): Promise<boolean> {
    return await invoke("cc_switch_restart_app");
  },

  async installUpdateAndRestart(): Promise<boolean> {
    return await invoke("cc_switch_install_update_and_restart");
  },

  async checkUpdates(): Promise<void> {
    await invoke("cc_switch_check_for_updates");
  },

  async isPortable(): Promise<boolean> {
    return await invoke("cc_switch_is_portable_mode");
  },
  ...
  async getClaudeCodeConfigPath(): Promise<string> {
    return await invoke("cc_switch_get_claude_code_config_path");
  },

  async getAppConfigPath(): Promise<string> {
    return await invoke("cc_switch_get_app_config_path");
  },

  async openAppConfigFolder(): Promise<void> {
    await invoke("cc_switch_open_app_config_folder");
  },

  async getAppConfigDirOverride(): Promise<string | null> {
    return await invoke("cc_switch_get_app_config_dir_override");
  },
  ...
  async applyClaudeOnboardingSkip(): Promise<boolean> {
    return await invoke("cc_switch_apply_claude_onboarding_skip");
  },

  async clearClaudeOnboardingSkip(): Promise<boolean> {
    return await invoke("cc_switch_clear_claude_onboarding_skip");
  },
  ...
  async webdavSyncUpload(): Promise<WebDavSyncResult> {
    return await invoke("cc_switch_webdav_sync_upload");
  },

  async webdavSyncDownload(): Promise<WebDavSyncResult> {
    return await invoke("cc_switch_webdav_sync_download");
  },
  ...
  > {
    return await invoke("cc_switch_webdav_sync_fetch_remote_info");
  },
  ...
  async s3SyncUpload(): Promise<WebDavSyncResult> {
    return await invoke("cc_switch_s3_sync_upload");
  },

  async s3SyncDownload(): Promise<WebDavSyncResult> {
    return await invoke("cc_switch_s3_sync_download");
  },
  ...
  async s3SyncFetchRemoteInfo(): Promise<RemoteSnapshotInfo | { empty: true }> {
    return await invoke("cc_switch_s3_sync_fetch_remote_info");
  },

  async syncCurrentProvidersLive(): Promise<void> {
    const result = (await invoke("cc_switch_sync_current_providers_live")) as {
      success?: boolean;
      message?: string;
    };
    if (!result?.success) {
  ...
  async getAutoLaunchStatus(): Promise<boolean> {
    return await invoke("cc_switch_get_auto_launch_status");
  },
  ...
  async getRectifierConfig(): Promise<RectifierConfig> {
    return await invoke("cc_switch_get_rectifier_config");
  },
  ...
  async getOptimizerConfig(): Promise<OptimizerConfig> {
    return await invoke("cc_switch_get_optimizer_config");
  },
  ...
  async getLogConfig(): Promise<LogConfig> {
    return await invoke("cc_switch_get_log_config");
  },
...
export const backupsApi = {
  async createDbBackup(): Promise<string> {
    return await invoke("cc_switch_create_db_backup");
  },

  async listDbBackups(): Promise<BackupEntry[]> {
    return await invoke("cc_switch_list_db_backups");
  },
