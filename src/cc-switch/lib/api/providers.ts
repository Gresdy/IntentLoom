...
export const providersApi = {
  ...
  async importClaudeDesktopFromClaude(): Promise<number> {
    return await invoke("cc_switch_import_claude_desktop_providers_from_claude");
  },

  async ensureClaudeDesktopOfficialProvider(): Promise<boolean> {
    return await invoke("cc_switch_ensure_claude_desktop_official_provider");
  },

  async getClaudeDesktopStatus(): Promise<ClaudeDesktopStatus> {
    return await invoke("cc_switch_get_claude_desktop_status");
  },

  async getClaudeDesktopDefaultRoutes(): Promise<ClaudeDesktopDefaultRoute[]> {
    return await invoke("cc_switch_get_claude_desktop_default_routes");
  },
  ...
  async importOpenCodeFromLive(): Promise<number> {
    return await invoke("cc_switch_import_opencode_providers_from_live");
  },
  ...
  async getOpenCodeLiveProviderIds(): Promise<string[]> {
    return await invoke("cc_switch_get_opencode_live_provider_ids");
  },
  ...
  async getOpenClawLiveProviderIds(): Promise<string[]> {
    return await invoke("cc_switch_get_openclaw_live_provider_ids");
  },
  ...
  async getHermesLiveProviderIds(): Promise<string[]> {
    return await invoke("cc_switch_get_hermes_live_provider_ids");
  },
  ...
  async importOpenClawFromLive(): Promise<number> {
    return await invoke("cc_switch_import_openclaw_providers_from_live");
  },
  ...
  async importHermesFromLive(): Promise<number> {
    return await invoke("cc_switch_import_hermes_providers_from_live");
  },
};
...
export const universalProvidersApi = {
  ...
  async getAll(): Promise<UniversalProvidersMap> {
    return await invoke("cc_switch_get_universal_providers");
  },
