...
export const openclawApi = {
  ...
  async getDefaultModel(): Promise<OpenClawDefaultModel | null> {
    return await invoke("cc_switch_get_openclaw_default_model");
  },
  ...
  async getModelCatalog(): Promise<Record<
    ...
    OpenClawModelCatalogEntry
  > | null> {
    return await invoke("cc_switch_get_openclaw_model_catalog");
  },
  ...
  async getAgentsDefaults(): Promise<OpenClawAgentsDefaults | null> {
    return await invoke("cc_switch_get_openclaw_agents_defaults");
  },
  ...
  async getEnv(): Promise<OpenClawEnvConfig> {
    return await invoke("cc_switch_get_openclaw_env");
  },
  ...
  async getTools(): Promise<OpenClawToolsConfig> {
    return await invoke("cc_switch_get_openclaw_tools");
  },
  ...
  async scanHealth(): Promise<OpenClawHealthWarning[]> {
    return await invoke("cc_switch_scan_openclaw_config_health");
  },
