...
export const skillsApi = {
  ...
  async getInstalled(): Promise<InstalledSkill[]> {
    return await invoke("cc_switch_get_installed_skills");
  },

  /** 获取可恢复的 Skill 备份列表 */
  async getBackups(): Promise<SkillBackupEntry[]> {
    return await invoke("cc_switch_get_skill_backups");
  },
  ...
  async scanUnmanaged(): Promise<UnmanagedSkill[]> {
    return await invoke("cc_switch_scan_unmanaged_skills");
  },
  ...
  async discoverAvailable(): Promise<DiscoverableSkill[]> {
    return await invoke("cc_switch_discover_available_skills");
  },

  /** 检查 Skills 更新 */
  async checkUpdates(): Promise<SkillUpdateInfo[]> {
    return await invoke("cc_switch_check_skill_updates");
  },
  ...
  async getAll(app: AppId = "claude"): Promise<Skill[]> {
    if (app === "claude") {
      return await invoke("cc_switch_get_skills");
    }
  ...
  async getRepos(): Promise<SkillRepo[]> {
    return await invoke("cc_switch_get_skill_repos");
  },
