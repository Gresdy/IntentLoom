...
export const hermesApi = {
  async getModelConfig(): Promise<HermesModelConfig | null> {
    return await invoke("cc_switch_get_hermes_model_config");
  },
  ...
  async launchDashboard(): Promise<void> {
    await invoke("cc_switch_launch_hermes_dashboard");
  },
  ...
  async getMemoryLimits(): Promise<HermesMemoryLimits> {
    return await invoke("cc_switch_get_hermes_memory_limits");
  },
