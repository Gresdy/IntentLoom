...
export const mcpApi = {
  async getStatus(): Promise<McpStatus> {
    return await invoke("cc_switch_get_claude_mcp_status");
  },

  async readConfig(): Promise<string | null> {
    return await invoke("cc_switch_read_claude_mcp_config");
  },
  ...
  async getAllServers(): Promise<McpServersMap> {
    return await invoke("cc_switch_get_mcp_servers");
  },
  ...
  async importFromApps(): Promise<number> {
    return await invoke("cc_switch_import_mcp_from_apps");
  },
};
