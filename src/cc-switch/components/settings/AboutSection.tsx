...
} from "@cc-switch/lib/api/settings";
import { useUpdate } from "@cc-switch/contexts/UpdateContext";
import { Badge } from "@cc-switch/components/ui/badge";
import { motion } from "framer-motion";
import appIcon from "@cc-switch/assets/icons/app-icon.png";
import { APP_ICON_MAP } from "@cc-switch/config/appConfig";
import type { AppId } from "@cc-switch/lib/api/types";
import { extractErrorMessage } from "@cc-switch/utils/errorUtils";
import { isWindows } from "@cc-switch/lib/platform";
import { isUpdateAvailable } from "@cc-switch/lib/version";
    ...
    try {
      ...
      if (!displayVersion) {
        await settingsApi.openExternal(
          "https://github.com/Gresdy/IntentLoom/releases",
        );
        return;
      }

      await settingsApi.openExternal(
        `https://github.com/Gresdy/IntentLoom/releases/tag/${displayVersion}`,
      );
    } catch (error) {
