...
import { isValidUserAgentHeader } from "@cc-switch/lib/userAgent";
import { USER_AGENT_PRESETS } from "@cc-switch/config/userAgentPresets";
 ...
 * `parse_custom_user_agent` 一致（见 `@cc-switch/lib/userAgent`），非法时给非阻断红字提示
 * （运行时仍会静默忽略）。
 */
