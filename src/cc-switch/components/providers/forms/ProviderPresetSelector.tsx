...
import { FormLabel } from "@cc-switch/components/ui/form";
import { Button } from "@cc-switch/components/ui/button";
import { Input } from "@cc-switch/components/ui/input";
import { ClaudeIcon, CodexIcon, GeminiIcon } from "@cc-switch/components/BrandIcons";
import {
  ArrowUpAZ,
  Search,
  Zap,
...
import type { ProviderPreset } from "@cc-switch/config/claudeProviderPresets";
import type { CodexProviderPreset } from "@cc-switch/config/codexProviderPresets";
import type { GeminiProviderPreset } from "@cc-switch/config/geminiProviderPresets";
import type { ClaudeDesktopProviderPreset } from "@cc-switch/config/claudeDesktopProviderPresets";
import type { OpenCodeProviderPreset } from "@cc-switch/config/opencodeProviderPresets";
import type { OpenClawProviderPreset } from "@cc-switch/config/openclawProviderPresets";
import type { HermesProviderPreset } from "@cc-switch/config/hermesProviderPresets";
import type { ProviderCategory } from "@cc-switch/types";
import {
  universalProviderPresets,
  type UniversalProviderPreset,
} from "@cc-switch/config/universalProviderPresets";
