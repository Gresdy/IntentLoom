...
import { Form, FormField, FormItem, FormMessage } from "@cc-switch/components/ui/form";
import { Input } from "@cc-switch/components/ui/input";
import { providerSchema, type ProviderFormData } from "@cc-switch/lib/schemas/provider";
import {
  buildLocalProxyRequestOverrides,
  formatRequestOverrideObject,
} from "@cc-switch/lib/requestOverrides";
import { providersApi, settingsApi, type AppId } from "@cc-switch/lib/api";
import { useDarkMode } from "@cc-switch/hooks/useDarkMode";
import type {
  ProviderCategory,
  ProviderMeta,
  ProviderTestConfig,
  ...
  CodexChatReasoning,
  ClaudeApiKeyField,
} from "@cc-switch/types";
import {
  providerPresets,
  type ProviderPreset,
} from "@cc-switch/config/claudeProviderPresets";
import {
  codexProviderPresets,
  type CodexProviderPreset,
} from "@cc-switch/config/codexProviderPresets";
import {
  geminiProviderPresets,
  type GeminiProviderPreset,
} from "@cc-switch/config/geminiProviderPresets";
import {
  opencodeProviderPresets,
  type OpenCodeProviderPreset,
} from "@cc-switch/config/opencodeProviderPresets";
import {
  openclawProviderPresets,
  rebaseOpenClawSuggestedDefaults,
  type OpenClawProviderPreset,
  type OpenClawSuggestedDefaults,
} from "@cc-switch/config/openclawProviderPresets";
import {
  hermesProviderPresets,
  type HermesProviderPreset,
} from "@cc-switch/config/hermesProviderPresets";
import { OpenCodeFormFields } from "./OpenCodeFormFields";
import { OpenClawFormFields } from "./OpenClawFormFields";
import { HermesFormFields } from "./HermesFormFields";
import type { UniversalProviderPreset } from "@cc-switch/config/universalProviderPresets";
import {
  applyTemplateValues,
  hasApiKeyField,
} from "@cc-switch/utils/providerConfigUtils";
import { mergeProviderMeta } from "@cc-switch/utils/providerMetaUtils";
import {
  extractCodexWireApi,
  setCodexWireApi,
  setCodexModelName as setCodexModelNameInConfig,
} from "@cc-switch/utils/providerConfigUtils";
import { isNonNegativeDecimalString } from "@cc-switch/types/usage";
import { getCodexCustomTemplate } from "@cc-switch/config/codexTemplates";
import CodexConfigEditor from "./CodexConfigEditor";
import { CommonConfigEditor } from "./CommonConfigEditor";
import GeminiConfigEditor from "./GeminiConfigEditor";
import JsonEditor from "@cc-switch/components/JsonEditor";
import { Label } from "@cc-switch/components/ui/label";
...
import { parseOmoOtherFieldsObject } from "@cc-switch/types/omo";
import {
...
import { useSettingsQuery } from "@cc-switch/lib/query";
import {
...
import { resolveManagedAccountId } from "@cc-switch/lib/authBinding";
import { useOpenClawLiveProviderIds } from "@cc-switch/hooks/useOpenClaw";
import { useHermesLiveProviderIds } from "@cc-switch/hooks/useHermes";
  ...
  const performSubmit = async (
    ...
    if (!isEditMode && draftCustomEndpoints.length > 0) {
      const customEndpointsToSave: Record<
        string,
        import("@cc-switch/types").CustomEndpoint
      > = draftCustomEndpoints.reduce(
        ...
        {} as Record<string, import("@cc-switch/types").CustomEndpoint>,
      );
