...
import { FullScreenPanel } from "@cc-switch/components/common/FullScreenPanel";
import type { Provider, CustomEndpoint, UniversalProvider } from "@cc-switch/types";
import type { AppId } from "@cc-switch/lib/api";
import { universalProvidersApi } from "@cc-switch/lib/api";
import {
  ProviderForm,
  type ProviderFormValues,
} from "@cc-switch/components/providers/forms/ProviderForm";
import { UniversalProviderFormModal } from "@cc-switch/components/universal/UniversalProviderFormModal";
import { UniversalProviderPanel } from "@cc-switch/components/universal";
import { providerPresets } from "@cc-switch/config/claudeProviderPresets";
import { codexProviderPresets } from "@cc-switch/config/codexProviderPresets";
import { geminiProviderPresets } from "@cc-switch/config/geminiProviderPresets";
import { claudeDesktopProviderPresets } from "@cc-switch/config/claudeDesktopProviderPresets";
import { extractCodexBaseUrl } from "@cc-switch/utils/providerConfigUtils";
import type { OpenClawSuggestedDefaults } from "@cc-switch/config/openclawProviderPresets";
