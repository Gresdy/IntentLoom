...
import { Provider, UsageScript, UsageData, createUsageScript } from "@cc-switch/types";
import { usageApi, settingsApi, type AppId } from "@cc-switch/lib/api";
import { copilotGetUsage, copilotGetUsageForAccount } from "@cc-switch/lib/api/copilot";
...
import { Switch } from "@cc-switch/components/ui/switch";
...
import { TEMPLATE_TYPES, PROVIDER_TYPES } from "@cc-switch/config/constants";
import {
  CODING_PLAN_PROVIDERS,
  detectCodingPlanProvider,
} from "@cc-switch/config/codingPlanProviders";
import { formatUsageDataSummary } from "@cc-switch/utils/usageDisplay";
  ...
  const handleTest = async () => {
    ...
    try {
      ...
      if (selectedTemplate === TEMPLATE_TYPES.OFFICIAL_SUBSCRIPTION) {
        const { subscriptionApi } = await import("@cc-switch/lib/api/subscription");
