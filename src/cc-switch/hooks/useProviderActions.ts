...
import { providersApi, settingsApi, openclawApi, type AppId } from "@cc-switch/lib/api";
import type {
  Provider,
  UsageScript,
...
import { injectCodingPlanUsageScript } from "@cc-switch/config/codingPlanProviders";
import {
