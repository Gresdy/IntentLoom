  ...
  return [
    ...
    // 15. summary — artifact tally
    {
      ...
      tally: {
        ...
        addedFiles: ["src/test/MessageAgentStatus.test.tsx", "src/test/MessageTips.test.tsx", "src/test/MessagePlan.test.tsx"],
        modifiedFiles: ["src/components/Chat/ReasonixComposer.tsx", "src/components/Chat/ReasonixTranscript.tsx"],
        deletedFiles: [],
        commandsRun: [
          "npm test -- --run src/test/MessageAgentStatus.test.tsx",
          "npm test -- --run src/test/MessageTips.test.tsx",
          "npm test -- --run src/test/MessagePlan.test.tsx",
          "npm test -- --run src/test/MessageCronTrigger.test.tsx",
          "npm test -- --run src/test/MessageSkillSuggest.test.tsx",
          "npm test",
        ],
      },
      agentId: "claude",
